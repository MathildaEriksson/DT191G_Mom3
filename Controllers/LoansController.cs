...
namespace DT191G_Mom3.Controllers
{
    public class LoansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LoanId,BorrowedDate,UserId,BookId")] Loan loan)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "UserId", "Name", loan.UserId);
            return View(loan);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LoanId,BorrowedDate,UserId,BookId")] Loan loan)
        {
            if (id != loan.LoanId)
            {
                return NotFound();
